Create a new page src/app/pages/Menu.tsx and add the route /menu to the router.
Use existing components where possible. Fetch content from Sanity with static fallback.
Do not change any existing page files.

--- CREATE FILE: src/app/pages/Menu.tsx ---
...
--- UPDATE FILE: src/app/routes.tsx ---

Add the Menu page import and route.

Import: import { Menu } from './pages/Menu';

Add route: { path: '/menu', element: <Menu /> }