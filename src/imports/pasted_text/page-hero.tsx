Make the following changes. Do not change any styling, layout, 
wave transitions, or component structure.

--- CHANGE 1: src/app/components/PageHero.tsx (FULL REPLACEMENT) ---
...
--- CHANGE 2: src/app/pages/Bedrijfsfeesten.tsx (FULL REPLACEMENT) ---
...
export function Bedrijfsfeesten() {
  ...
  useEffect(() => {
    sanityClient
      .fetch(`*[_type == "zakelijkeEventsPage"][0]`)
      .then(data => {
        if (!data) return;
